...
def cox_multivariate_analysis(df, selected_feats, event_col, time_col):
    ...
    # normalize features
    data[selected_feats] = (data[selected_feats]-data[selected_feats].mean())/(data[selected_feats].std()+0.000000001)
    ...
    for event_type in event_types:
        ...
        for cancer in cancer_types:
            ...
            try:
                ...
                summary = cox_multivariate_analysis(cancer_df, selected_feats, event_col, time_col)
