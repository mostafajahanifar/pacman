...
immune_feats = [
    "Proliferation", 
                # "Th1 Cells","Th2 Cells","Th17 Cells", # "Th1/Th2 cell ratio",
                # "NK Cells Activated","NK Cells Resting",#"NK Cells Resting/Activated ratio",
                # "T Cells Regulatory Tregs",
                # "B Cells Memory","B Cells Naive",
                # "Dendritic Cells Activated","Dendritic Cells Resting",#"Dendritic Cells Resting/Activated ratio",
                # "Monocytes","Macrophages M0","Macrophages M1","Macrophages M2", #"Macrophages M1/M2 ratio","Macrophages M2/M1 ratio",
                # "Macrophages M2:Th1 ratio",
                # "Mast Cells Activated","Mast Cells Resting", #"Mast Cells Resting/Activated ratio",
                # "Plasma Cells",
                # "T Cells CD4 Memory Activated","T Cells CD4 Memory Resting","T Cells CD4 Naive",#"T Cells CD4 Resting/Activated ratio",
                # "T Cells CD8",
...
plt.savefig(f"results_final_all/immune/{feat}_correlations_new.png", dpi=600, bbox_inches = 'tight', pad_inches = 0.01)
