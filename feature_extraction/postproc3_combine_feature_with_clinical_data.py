...
df_csv = pd.read_csv('/mnt/gpfs01/lsf-workspace/u2070124/Data/Data/pancancer/features_final/_all_combined_single-slide-cases.csv')
...
merged_df.to_csv('/mnt/gpfs01/lsf-workspace/u2070124/Data/Data/pancancer/tcga_features_final.csv', index=False)
