...
pivot_significant = df.pivot(index='cancer_type', columns='event_type', values='significant')
...
mean_row = pivot_mean[(pivot_success == 1) & (pivot_significant == 1)].mean().apply("{:.3f}".format)
