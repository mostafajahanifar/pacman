...
if __name__ == "__main__":
    ...
    for cancer_types in ["Pan-cancer"] + ALL_CANCERS:
        ...
        if cancer_types != ["Pan-cancer"]:
            ...
            mitosis_feats_cancer = mitosis_feats.loc[
        ...
        save_root = os.path.join(
            RESULTS_DIR, f"genomic/{args.mode}/{cancer_types_name}"
        )
        ...
        corr_matrix, pvalue_matrix = calculate_corr_matrix(
            X, Y, method=args.method, pvalue_correction="fdr_bh"
        )
